...
def test_refresh_token_success(mock_strava_response, mock_strava_secret):
    ...
    with patch('cloud_functions.token_refresh.main.firestore.Client', return_value=mock_db), \
         patch('cloud_functions.token_refresh.strava.Client.refresh_access_token', return_value=mock_strava_response), \
         patch('cloud_functions.token_refresh.secrets.get_secret', return_value=mock_strava_secret):
...
def test_refresh_token_missing_credentials():
    ...
    # Mock empty secret
    with patch('cloud_functions.token_refresh.main.firestore.Client', return_value=mock_db), \
         patch('cloud_functions.token_refresh.secrets.get_secret', return_value={}):
